...
def obtener_codigo_activo(propietario_id: str) :
...
def obtener_url_factura(user_id: str, ruta: str, expira_segundos: int = 3600) :
    """
...
def obtener_url_factura_recibida(user_id: str, ruta: str, expira: int = 3600) :
